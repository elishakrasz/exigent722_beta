...
const ContactFormik = () => {
    ...
    const validationSchema = Yup.object().shape({
        firstName: Yup.string()
            ...
            .min(3, 'Entry must be 3 characters or more')
        ...
        lastName: Yup.string()
            ...
            .max(16, 'Must be 16 characters or less'),
        // aliyah: Yup.date()
        //     .required('Please supply your estimated date of Aliyah'),
        phone: Yup.string()
          ...
          <div >
            ...
            >
              <div className="mb-4">
                ...
                <input
                  // className={`form-control shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${errors.firstName ? 'is-invalid' : ''}`}  
